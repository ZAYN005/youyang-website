...
export const metadata: Metadata = {
  ...
  title:
    "Transportation Hubs & Critical Sites | AI Monitoring Solutions | Youyang Intelligent Control",

  description:
    "Youyang Intelligent Control provides AI-powered intelligent sensing solutions for airports, railway stations, metro systems, and critical transportation environments with wide-area monitoring and real-time situation awareness.",
